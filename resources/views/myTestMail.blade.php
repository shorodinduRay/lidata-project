    ...
    <div class="row">
        ...
        <div class="col-xs-5">
            <table style="width: 100%">
                ...
                <tr>
                    <th>Invoice Num:</th>
                    <td class="text-right">{{ $invoiceNum }}</td>
                </tr>
                <tr>
                    <th>Invoice Date:</th>
    ...
    <div class="row">
        <div class="col-xs-8 invbody-terms">
            ...
            <p>
                ...
                quia, aut doloremque, voluptatibus quam ipsa sit sed enim nam dicta.
                Soluta eaque rem necessitatibus commodi, autem facilis iusto
                impedit!
            </p>
        </div>
    </div>
