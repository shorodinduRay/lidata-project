                        ...
                        <div class="card border-0 rounded-3">
                            <div class="card-body p-5 pb-3">
                                <form action="{{ route('add.new.user.by.admin') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <button type="submit" class="btn btn-blue rounded-3 u-box-shadow-2 mt-5 mb-4 px-5 mx-auto bg-primary d-flex">
                                        ADD USER
                                    </button>
                ...
                <div class="card border-0 rounded-3">
                    <div class="card-body p-5 pb-3">
                        ...
                        <form action="{{ route('reset.user.password') }}" enctype="multipart/form-data" method="post">
                            ...
                            <button type="submit" class="btn btn-blue rounded-3 u-box-shadow-2 mt-5 mb-4 px-5 mx-auto bg-primary">
                                Reset Password
                            </button>
