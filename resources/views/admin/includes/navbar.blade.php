<section class="section-dashboard--sidebar">
    ...
    <nav class="menubar">
        <ul class="menu d-flex flex-column">
            ...
            <li class="menu-item {{  request()->routeIs('view.all.company') ? 'active' : '' }}">
                <a href="{{ route('view.all.company') }}">
            ...
            <li class="menu-item {{  request()->routeIs('add.new.user.by.admin') ? 'active' : '' }}">
                <a href="{{ route('add.new.user.by.admin') }}" >
            ...
            <li class="menu-item {{  request()->routeIs('user.data.import') ? 'active' : '' }}">
                <a href="{{ route('user.data.import') }}" >
            ...
            <li class="menu-item {{  request()->routeIs('user.order.history') ? 'active' : '' }}">
            ...
            <li class="menu-item {{  request()->routeIs('user.credit.history') ? 'active' : '' }}">
                <a href="{{ route('user.credit.history') }}" >
            ...
            <li class="menu-item {{  request()->routeIs('user.payment.settings') ? 'active' : '' }}">
                <a href="{{ route('user.payment.settings') }}" >
