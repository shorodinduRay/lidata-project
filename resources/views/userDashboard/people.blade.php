                                        ...
                                        <form action="{{ route('customExport') }}" enctype="multipart/form-data" method="get">
                                            ...
                                            <tr>
                                                ...
                                                || isset($city) != null || isset($state) != null || isset($industry) != null )
                                                    ...
                                                    @if(isset($jobTitle)) <input type="text" name="jobTitle" value="{{ $jobTitle }}" hidden />@endif
                                                ...
                                                @else
                                                    <th><input id="checkAll" type="button" class="selectAll" value="Select All"/></th>
                                                @endif
                                            ...
                                            <tbody>
                                                @foreach ($allData as $data)
                                                    <tr class="table-row">
                                                        ...
                                                        <td>
                                                            <a href="{{ route('user', ['id' => $data->id, 'name'=>$data->person_first_name_unanalyzed."-".$data->person_last_name_unanalyzed ]) }}" class="person-name">
        ...
        $.ajax({
            ...
            success:function(data)
            {
                ...
                for (var count = 0; count < data.length; count++) {
                    ...
                    if (data[count].person_email != null)
