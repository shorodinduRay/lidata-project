                    ...
                    <div class="card-bg">
                        <div class="container">
                            ...
                            <div class="row border-bottom">
                                ...
                                <div class="col-md-4">
                                    <p>{{ $userPurchasePlan[1] }} Reward Credits</p>
                                    <p>{{ $userPurchasePlan[2] }} Email Credits / mo</p>
                                </div>
            ...
            <div class="card u-box-shadow-2 m-4 border rounded-3">
                ...
                >
                    <h3 class="p-4 text-capitalize">
                        Credits Usage <span> ( {{ $userPurchasePlan[4] }} {{ $userPurchasePlan[5] }} {{ $userPurchasePlan[6] }}  - {{ $userPurchasePlan[7] }} {{ $userPurchasePlan[8] }} {{ $userPurchasePlan[9] }} ) </span>
                    </h3>
                    <a
                        href="{{ route('upgrade') }}"
                        type="button"
