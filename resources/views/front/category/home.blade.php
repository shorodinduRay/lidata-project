                    ...
                    <span class="text-secondary">A</span>
                            ...
                            <p class="card-text">
                                @forelse ($data as $allData)
                                    <a href="{{ route('user', ['id' => $allData->id, 'name'=>$allData->person_first_name_unanalyzed."-".$allData->person_last_name_unanalyzed]) }}" class="user-link"
                                    >{{$allData->person_first_name_unanalyzed." ".$allData->person_last_name_unanalyzed }}</a>
                                @empty
